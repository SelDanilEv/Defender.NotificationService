...
namespace Defender.IdentityService.Infrastructure.Clients.NotificationClient
{
    ...
    public partial interface INotificationClient
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<NotificationResponse> VerificationEmailAsync(SendVerificationEmailCommand body);

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<NotificationResponse> VerificationEmailAsync(SendVerificationEmailCommand body, System.Threading.CancellationToken cancellationToken);
    ...
    public partial class NotificationClient : INotificationClient
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<NotificationResponse> VerificationEmailAsync(SendVerificationEmailCommand body)
        {
            return VerificationEmailAsync(body, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<NotificationResponse> VerificationEmailAsync(SendVerificationEmailCommand body, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
